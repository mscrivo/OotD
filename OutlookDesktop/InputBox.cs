...
public class InputBox : System.Windows.Forms.Form
{
    ...
    private void InitializeComponent()
    {
        ...
        this.buttonOK.Location = new System.Drawing.Point(128, 72);
        ...
        this.buttonCancel.Location = new System.Drawing.Point(216, 72);
        ...
        this.textBoxText.Size = new System.Drawing.Size(274, 20);
    ...
    public static InputBoxResult Show(Form owner, string prompt, string title, string defaultResponse, InputBoxValidatingHandler validator, int xpos, int ypos)
    {
    ...
    /// <param name="validator">Delegate used to validate the text</param>
    /// <returns>An InputBoxResult object with the Text and the OK property set to true when OK was clicked.</returns>
    public static InputBoxResult Show(Form owner, string prompt, string title, string defaultText, InputBoxValidatingHandler validator)
    {
        return Show(owner, prompt, title, defaultText, validator, -1, -1);
    }
