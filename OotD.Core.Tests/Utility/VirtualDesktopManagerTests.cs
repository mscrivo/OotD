...
public class VirtualDesktopManagerTests
{
    ...
    {
        // Act
        var isSupported = VirtualDesktopManager.IsVirtualDesktopSupported;
    ...
    [Fact]
    public void IsWindowOnDesktop_WithInvalidHandle_ShouldReturnFalse()
    {
        // Arrange
        var invalidHandle = IntPtr.Zero;
        var randomDesktopId = Guid.NewGuid();
        ...
        // Act
        var result = VirtualDesktopManager.IsWindowOnDesktop(invalidHandle, randomDesktopId);
